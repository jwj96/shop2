...
public class ItemController {
    ...
    public String itemNew(@Valid ItemFormDto itemFormDto, BindingResult bindingResult, Model model, @RequestParam(value="itemImgFile", required=false)List<MultipartFile> itemImgFileList){
        ...
        try {
            ...
            model.addAttribute("errorMessage", "삼품 등록 중 에러가 발생하였습니다.");
            return "item/itemForm";
        }
        return "redirect:/";
    }
    ...
    public String itemManage(ItemSearchDto itemSearchDto, @PathVariable(value="page", required = false) Optional<Integer> page, Model model){
